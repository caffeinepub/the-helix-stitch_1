...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: ExternalBlob | null, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markOrdersSeen(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markOrdersSeen();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
